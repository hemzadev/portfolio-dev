...
import TechSkillsGrid from "./TechSkillsGrid"
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 xl:px-12 py-4 sm:py-8">
        <div className="w-full max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center lg:items-end justify-between gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left space-y-4 lg:space-y-6">
            <h1 className="hero-title text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
              Salam, my name is <span className="text-indigo-600 dark:text-indigo-400">Hamza</span> and I'm a <span className="text-indigo-600 dark:text-indigo-400">Software Engineer</span>
            </h1>

            <div className="hero-p text-base sm:text-lg md:text-xl lg:text-xl xl:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              I'm a software engineer from{" "}
              <span className="inline-flex items-center gap-1">
                Morocco <Lottie animationData={moroccoFlag} loop autoplay style={{ width: '1.5rem', height: '1.5rem' }} />
              </span>
              , and my goal is to contribute to innovative projects within leading <span className="font-semibold text-indigo-600 dark:text-indigo-400">multinational companies</span> and <span className="font-semibold text-indigo-600 dark:text-indigo-400">financial institutions</span>.
            </div>
          </div>
          ...
          <div className="hero-visual flex-1 flex justify-center lg:justify-end relative">
            <div className="relative w-64 sm:w-72 md:w-80 lg:w-96">
              {/* Gradient Header */}
              <div className="h-14 lg:h-16 w-full bg-gradient-to-t from-indigo-400 via-violet-300 to-transparent dark:from-indigo-600 dark:via-violet-500 dark:to-transparent rounded-t-lg" />

              {/* Image Container */}
              <div className="relative w-full aspect-[3/4] rounded-b-full overflow-hidden bg-gray-200 dark:bg-gray-700 shadow-lg">
