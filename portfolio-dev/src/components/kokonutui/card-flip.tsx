 ...
 * @description: Card Flip (Indigo Themed by Hamza)
 * @version: 1.1.0
 * @date: 2025-10-15
 * @license: MIT
 */
          ...
          <div className="pt-6 mt-6 border-t border-zinc-200 dark:border-zinc-800">
            <div
              className={cn(
                ...
                // Indigo hover gradients
                "hover:from-indigo-500/10 hover:from-0% hover:via-indigo-500/5 hover:via-100% hover:to-transparent hover:to-100%",
                "dark:hover:from-indigo-500/20 dark:hover:from-0% dark:hover:via-indigo-500/10 dark:hover:via-100% dark:hover:to-transparent dark:hover:to-100%",
                "hover:scale-[1.02] hover:cursor-pointer"
              )}
            >
              <span className="text-sm font-medium text-zinc-900 dark:text-white transition-colors duration-300 group-hover/start:text-indigo-600 dark:group-hover/start:text-indigo-400">
                Start today
              </span>
              <div className="relative group/icon">
                <div
                ...
                />
                <ArrowRight className="relative z-10 w-4 h-4 text-indigo-500 transition-all duration-300 group-hover/start:translate-x-0.5 group-hover/start:scale-110" />
              </div>
            </div>
          </div>
        </div>
      ...
      <style jsx>{`
        @keyframes scale {
          0% {
            transform: scale(2);
            opacity: 0;
            box-shadow: 0px 0px 50px rgba(79, 70, 229, 0.5);
          }
          50% {
          ...
          100% {
            ...
            opacity: 0;
            box-shadow: 0px 10px 20px rgba(79, 70, 229, 0);
          }
        }
      `}</style>
    </div>
