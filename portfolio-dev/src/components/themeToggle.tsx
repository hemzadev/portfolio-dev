...
export const useThemeToggle = ({
    ...
    // Return mounted state to handle rendering
    return {
  ...
  if (!mounted) {
    return (
      <button
        type="button"
        className={cn(
          "size-9 cursor-pointer rounded-full bg-gray-400 p-0 transition-all duration-300",
          className,
        )}
...
export const createAnimation = (
  ...
  // ... rest of the createAnimation function remains the same
  // (I've truncated it for brevity, but you should include the full function)
  return {
    name: `${variant}-${start}${blur ? "-blur" : ""}`,
    css: `
      ::view-transition-group(root) {
